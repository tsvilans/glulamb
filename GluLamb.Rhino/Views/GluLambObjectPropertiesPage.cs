...
using GluLamb.Properties;
using Eto.Drawing;

namespace GluLamb.Views
{
    public class GluLambObjectPropertiesPage : ObjectPropertiesPage
    {
        private GluLambObjectPropertiesPageControl m_page_control = null;
        ...
        {
            var icon = DrawingUtilities.LoadIconWithScaleDown(
              "GluLamb.Resources.GluLamb.ico",
              sizeInPixels.Width,
              GetType().Assembly);
            return icon;
        }

        public override object PageControl => m_page_control ?? (m_page_control = new GluLambObjectPropertiesPageControl());

        public override bool ShouldDisplay(ObjectPropertiesPageEventArgs e)
        {
            Debug.WriteLine("GluLambPropertiesPage.ShouldDisplay()");
            return true;
        }

        public override void UpdatePage(ObjectPropertiesPageEventArgs e)
        {
            var objs = e.GetObjects<Rhino.DocObjects.BrepObject>();
            if (objs.Length > 0)
            {
    ...
    public class GluLambObjectPropertiesPageControl : Panel
    {
        ...
        public GluLambObjectPropertiesPageControl()
        {
    ...
    class SampleCsEtoPropertiesPageControl : Panel
    {
        ...
        {
            Dialogs.ShowMessage("Is child.", "Sample");
