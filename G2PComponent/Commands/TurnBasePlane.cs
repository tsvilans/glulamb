...
{
    public class TurnComponentPlaneCommand : Command
    {
        public TurnComponentPlaneCommand()
        {
            Instance = this;
        }

        public static TurnComponentPlaneCommand Instance
        {
            get; private set;
        }

        public override string EnglishName => "TurnComponentPlane";
