...
namespace G2PComponents.Commands
{
    ...
    /// </summary>
    public class IdentifyCloneComponentsCommand : Command
    {
        public override string EnglishName => "IdentifyCloneComponents";

        public IdentifyCloneComponentsCommand()
        {
            Instance = this;
        }

        public static IdentifyCloneComponentsCommand Instance
        {
            get; private set;
        }
